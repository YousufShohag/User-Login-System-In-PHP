...
<div class="container">
	<div class="row">
		<div class="col-md-6 offset-md-3 border">
			...
			<button class="btn btn-primary form-control mb-3" name="submit" type="submit">Log In</button>
			</form>
			<label>I am not a member<a href="registration.php"> Register here</a></label>
		</div>
	</div>
</div>
